...
/*
    Changed the original gyro_accelerometer_tutorial03.c into an Erlang port July 24 2015
...
int main(int argc, char *argv[])
{
	...
	*/
	...
	//Kalman Filter
	kalmanX = (double) kalmanFilterX(AccXangle, rate_gyr_x);
	kalmanY = (double) kalmanFilterY(AccYangle, rate_gyr_y);
	...
	//Each loop should be at least 20ms.
        ...
        memcpy(buf, (unsigned char*) (&kalmanX), 8);
        memcpy(buf + 8, (unsigned char*) (&kalmanY), 8);
        write_cmd(buf, 16);
    }
}
